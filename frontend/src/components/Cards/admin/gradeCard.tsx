    ...
    <div className="w-full bg-surface border-3 border-light/10 rounded-xl p-5 hover:-translate-y-1 transition-all duration-300 group flex flex-col hover:shadow-md hover:border-primary hover:shadow-primary/50">
      ...
      <div className="flex justify-between items-start mb-1">
        <div className="flex flex-col gap-2">
          ...
          <span className={`flex w-full justify-around items-center gap-1.5 px-2.5 py-1 rounded-xl text-[11px] font-bold uppercase tracking-widest border-2 ${isActive ? 'bg-success/10 text-success border-success/40' : 'bg-failure/10 text-failure border-failure/40'}`}>
