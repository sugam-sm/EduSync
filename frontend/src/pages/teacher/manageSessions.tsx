...
import { Loader2, PlayCircle, History, Activity } from "lucide-react";
...
export const ManageSessions = () => {
    ...
    const filteredSessions = sessions.filter(s => 
        sectionMode === 'active' ? s.is_active : !s.is_active
    );
                        ...
                        <div className="flex flex-col items-center justify-center h-full text-center p-10 space-y-4">
                            <div>
                                ...
                                <p className="text-text-muted font-semibold text-sm max-w-sm mx-auto">
                                    Choose a grade from the dropdown above to view live sessions or manage attendance history.
                                </p>
                            </div>
                        </div>
                    ) : (
